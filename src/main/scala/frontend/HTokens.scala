...
object HTokens {
  val tokens = new Object with HTokens
  trait HTokens extends Tokens {
    sealed abstract class HToken extends Token {
      override def toString = chars
    }

    case class Ident(name: String) extends HToken{ def chars: String = "id(" + name + ")" }

    case object IntType extends HToken { def chars: String = "int" }
    case object ShortType extends HToken { def chars: String = "short" }
    ...
    case object Typedef extends HToken { def chars: String = "typedef" }
